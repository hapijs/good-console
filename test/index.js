...
describe('GoodConsole', function () {
    ...
    describe('_report()', function () {
        ...
        describe('printResponse()', function () {
            ...
            it('logs to the console for "response" events with headers and a requestPayload and with options logHeaderPayloadWhenProvided and logRequestPayloadWhenProvided both enabled', function (done) {
